...
def get_cifar100_dataloaders(batch_size=128, num_workers=8, is_instance=False, attacker=None):
    """
    cifar 100
    """
...
def get_cifar100_dataloaders_augmix(batch_size=128, num_workers=8, is_instance=False, attacker=None, distributed=False):
    """
    cifar 100
    """
    data_folder = get_data_folder()
